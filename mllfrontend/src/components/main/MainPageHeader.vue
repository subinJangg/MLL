<template>
  <div class = "row" style="backgroundColor:#A6BB8D">
    <ul class="nav justify-content-end" style="backgroundColor:#EEEEEE">
      <!-- 로그인 화면 -->
      <li class="nav-item ">
        <router-link
    ...
    <ul class="nav justify-content-center" style="backgroundColor:#EEEEEE">
      <!-- 홈화면 -->
      <li class="nav-item ">
        <router-link
          class="nav-link active cur"
